...
function mp_emmet_customize_register( $wp_customize ) {
	...
	/*
	 *  Add the 'Display breadcrumbs' setting.
	 */
	$wp_customize->add_setting( 'theme_display_breadcrumbs', array(
		'default'           => 1,
		'sanitize_callback' => 'mp_emmet_sanitize_checkbox',
	) );
	/*
	 * Add the upload control for the 'Display breadcrumbs' setting.
	 */
	$wp_customize->add_control(
		new WP_Customize_Control(
			$wp_customize, 'theme_display_breadcrumbs', array(
			'label'    => esc_html__( 'Display breadcrumbs', 'emmet-lite' ),
			'section'  => 'theme_general_section',
			'settings' => 'theme_display_breadcrumbs',
			'type'     => 'checkbox',
			'priority' => 2
		) )
	);
	...
	$wp_customize->add_setting(
		'theme_header_image_bg', array(
			...
			'capability'        => 'edit_theme_options',
			'sanitize_callback' => 'mp_emmet_theme_sanitize_custom_image'
		)
	);
	...
	/*
	 * Add the upload control for the 'vk link' setting.
	 */
	$wp_customize->add_control(
		'theme_vk_link', array(
			'label'    => esc_html__( 'Vk link', 'emmet-lite' ),
			'section'  => 'theme_header_socials',
			'settings' => 'theme_vk_link',
		)
	);
	/*
	 * Add the 'Skype link' setting.
	 */
	$wp_customize->add_setting(
		'theme_skype_link', array(
			'capability'        => 'edit_theme_options',
			'transport'         => 'postMessage',
			'sanitize_callback' => 'mp_emmet_sanitize_text',
		)
	...
	/*
	 * Add the upload control for the 'Skype link' setting.
	 */
	$wp_customize->add_control(
		'theme_skype_link', array(
			'label'    => esc_html__( 'Skype name', 'emmet-lite' ),
			'section'  => 'theme_header_socials',
			'settings' => 'theme_skype_link',
		)
	);
    /*
     * Add the 'Meetup link' setting.
     */
    $wp_customize->add_setting(
        'theme_meetup_link', array(
            'capability'        => 'edit_theme_options',
            'transport'         => 'postMessage',
            'sanitize_callback' => 'mp_emmet_sanitize_text',
        )
    ...
    /*
     * Add the upload control for the 'Meetup link' setting.
     */
    $wp_customize->add_control(
        'theme_meetup_link', array(
            'label'    => esc_html__( 'Meetup link', 'emmet-lite' ),
            'section'  => 'theme_header_socials',
            'settings' => 'theme_meetup_link',
        )
    );
	/*
	 * Add 'header_socials' section
	 ...
	 */
	$wp_customize->add_setting( 'theme_bigtitle_id', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'mp_emmet_sanitize_attr',
		'transport'         => 'postMessage'
	) );
	/*
	 * Add the upload control for the  'Section id' setting.
	 */
	$wp_customize->add_control( 'theme_bigtitle_id', array(
		'label'    => __( 'Custom Section ID', 'emmet-lite' ),
		'section'  => 'theme_bigtitle_section',
		'settings' => 'theme_bigtitle_id',
		'priority' => 35,
	) );
	/*
	 ...
	 * Add the 'Section id' setting.
	 */
	$wp_customize->add_setting( 'theme_welcome_id', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'mp_emmet_sanitize_attr',
		'transport'         => 'postMessage'
	 ...
	 * Add the upload control for the  'Section id' setting.
	 */
	$wp_customize->add_control( 'theme_welcome_id', array(
		'label'    => __( 'Custom Section ID', 'emmet-lite' ),
		'section'  => 'theme_welcome_section',
		'settings' => 'theme_welcome_id',
		'priority' => 35
	) );
	/*
	 ...
	 * Add the 'Section id' setting.
	 */
	$wp_customize->add_setting( 'theme_third_id', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'mp_emmet_sanitize_attr',
		'transport'         => 'postMessage'
	 ...
	 * Add the upload control for the  'Section id' setting.
	 */
	$wp_customize->add_control( 'theme_third_id', array(
		'label'    => __( 'Custom Section ID', 'emmet-lite' ),
		'section'  => 'theme_third_section',
		'settings' => 'theme_third_id',
		'priority' => 35
	) );
	...
	* Add the 'Section id' setting.
	*/
	$wp_customize->add_setting( 'theme_accent_id', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'mp_emmet_sanitize_attr',
		'transport'         => 'postMessage'
	 ...
	 * Add the upload control for the  'Section id' setting.
	 */
	$wp_customize->add_control( 'theme_accent_id', array(
		'label'    => __( 'Custom Section ID', 'emmet-lite' ),
		'section'  => 'theme_accent_section',
		'settings' => 'theme_accent_id',
		'priority' => 35
	) );
	/*
	...
	* Add the 'Section id' setting.
	*/
	$wp_customize->add_setting( 'theme_subscribe_id', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'mp_emmet_sanitize_attr',
		'transport'         => 'postMessage'
	 ...
	 * Add the upload control for the  'Section id' setting.
	 */
	$wp_customize->add_control( 'theme_subscribe_id', array(
		'label'    => __( 'Custom Section ID', 'emmet-lite' ),
		'section'  => 'theme_subscribe_section',
		'settings' => 'theme_subscribe_id',
		'priority' => 35
	) );
	/*
	...
	* Add the 'Section id' setting.
	*/
	$wp_customize->add_setting( 'theme_lastnews_id', array(
		'default'           => '',
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'mp_emmet_sanitize_attr',
		'transport'         => 'postMessage'
	 ...
	 * Add the upload control for the  'Section id' setting.
	 */
	$wp_customize->add_control( 'theme_lastnews_id', array(
		'label'    => __( 'Custom Section ID', 'emmet-lite' ),
		'section'  => 'theme_lastnews_section',
		'settings' => 'theme_lastnews_id',
		'priority' => 35
	) );
}

function mp_emmet_theme_sanitize_pro_version( $input ) {
  return $input;
  }
 ...
 * @return sanitized output
 */
function mp_emmet_theme_sanitize_custom_image( $input ) {
	return '';
}
 ...
 * @since Emmet 1.0
 */
function mp_emmet_theme_customize_preview_js() {
	wp_enqueue_script( 'emmet-theme-customizer', get_template_directory_uri() . '/js/theme-customizer.min.js', array( 'customize-preview' ), mp_emmet_get_theme_version(), true );
}

add_action( 'customize_preview_init', 'mp_emmet_theme_customize_preview_js' );
 ...
 * @since Emmet 1.0
 */
function mp_emmet_theme_customize_control_js() {
	wp_enqueue_script( 'emmet-color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.min.js', array(
		'customize-controls',
		'iris',
		'underscore',
		'wp-util'
	), '20141216', true );
	wp_localize_script( 'emmet-color-scheme-control', 'colorScheme', mp_emmet_get_color_schemes() );
}

add_action( 'customize_controls_enqueue_scripts', 'mp_emmet_theme_customize_control_js' );
...
if ( ! function_exists( 'mp_emmet_sanitize_attr' ) ) :
	 ...
	 * @return sanitized output
	 */
	function mp_emmet_sanitize_attr( $str ) {
		return esc_attr( $str ) ;
	}
endif;
