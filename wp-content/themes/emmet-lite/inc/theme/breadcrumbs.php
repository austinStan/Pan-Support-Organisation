...
function mp_emmet_the_breadcrumb() {
    $mp_emmet_display_breadcrumbs = esc_attr( get_theme_mod( 'theme_display_breadcrumbs', '1' ) );
    if ($mp_emmet_display_breadcrumbs===''){
       return;
    }
