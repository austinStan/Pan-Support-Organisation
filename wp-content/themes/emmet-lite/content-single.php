...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <footer class="entry-footer">
        <?php if (get_theme_mod('theme_show_meta', '1') === '1' || get_theme_mod('theme_show_meta')): ?>
            <div class="meta">
                ...
                <?php if (comments_open()) : ?>
                    <span class="seporator">/</span>
                    <a class="blog-icon underline" href="#comments" ><span><?php comments_number('0', '1', '%'); ?> <?php esc_html_e('Comments', 'emmet-lite'); ?></span></a>
                <?php endif; ?>
        ...
        <?php if (get_theme_mod('theme_show_categories', '1') === '1' || get_theme_mod('theme_show_categories')): ?>
            ...
            <?php if (!empty($categories)) : ?>
                <div class="wrapper-post-categories">
                    <h5><?php esc_html_e('Posted in', 'emmet-lite') ?></h5>
        ...
        <?php if (get_the_author_meta('description') && is_multi_author()) : ?>
            <?php get_template_part('info-author'); ?>
        <?php endif; ?>
        <?php
        ...
        if ($tags) {
            ...
            <div class="posts-related">
                <h5><?php esc_html_e('Related posts', 'emmet-lite'); ?></h5>
                <div class="row">
                    <?php
                    $tag_ids = array();
                            ...
                            <?php else: ?>
                                <div class="thumb-related thumb-default">
                                    <a class="date-post h6" rel="external" alt="<?php the_title(); ?>" href="<?php the_permalink() ?>">
                                        <?php echo esc_html(get_post_time('F j, Y',false,null,true )); ?>
                                    </a>
                                </div>                                
                            <?php endif; ?>
