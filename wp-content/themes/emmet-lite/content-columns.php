...
<article id="post-<?php the_ID(); ?>" <?php post_class('post-in-blog col-lg-6 col-md-6 col-sm-6 col-xs-12'); ?>>
            ...
            <div class="meta">
                ...
                <?php if (comments_open()) : ?>
                    ...
                    <a class="blog-icon underline" href="#comments" >
                        <span><?php comments_number('0', '1', '%'); ?> <?php esc_html_e('Comments', 'emmet-lite'); ?></span>
                    </a>
                <?php endif; ?>
    ...
    <section class="entry-content">
        ...
        <p><a class="more-link underline" href="<?php the_permalink(); ?>"><?php esc_html_e('Read More', 'emmet-lite'); ?></a></p>
    </section>
</article><!-- #post -->
