 ...
 * add home link.
 */
function business_consult_nav_wrap() {
...
function business_consult_customize_register( $wp_customize ) {
	...
	//slider button link
		...
		'label' => __('Slider Button Link','business-consult' ),
...
//load child theme color scheme
require get_stylesheet_directory() .'/inc/child-css.php';
//load widgets
